...
def create_gui():
    ...
    url = "https://cdn.discordapp.com/attachments/948199395072016454/1118090728984301628/MDP.png"
    response = requests.get(url)
    image_data = response.content
    
    layout = [[sg.VPush()],
                [sg.Push(), sg.Image(data = image_data, size = (200,120), subsample =5), sg.Push()],
